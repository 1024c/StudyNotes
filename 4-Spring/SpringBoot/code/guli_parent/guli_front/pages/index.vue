                ...
                <li v-for="course in courseList" :key="course.id">
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      ...
                      >
                      <div class="cc-mask">
                        <a :href="'#'+course.id" title="开始学习" class="comm-btn c-btn-1">开始学习</a>
                      </div>
                    </section>
                    <h3 class="hLh30 txtOf mt10">
                      <a :href="'#'+course.id" title="course.title" class="course-title fsize18 c-333">{{ course.title }}</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span v-if="Number(course.price) === 0" class="fr jgTag bg-green">
                        <em class="c-fff fsize12 f-fA">免费</em>
                      </span>
                      <span v-else class="fr jgTag bg-green" >
                        <em class="c-fff fsize12 f-fA">$ {{ course.price }}</em>
                      </span>
                      <span class="fl jgAttr c-ccc f-fA">
                        <em class="c-999 f-fA">{{ course.viewCount }} 人观看</em>
                        |
                        <em class="c-999 f-fA">{{ course.buyCount }} 人购买</em>
                      </span>
                    </section>
                  </div>
                </li>
